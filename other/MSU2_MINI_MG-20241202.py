...
def Get_MSN_Device():  # 尝试获取MSN设备
    global Device_State, ADC_det, Thread1, ser, State_change, machine_model, My_MSN_Device, My_MSN_Data, Screen_Error, Label1, LCD_Change_now, Text1
...
def MSN_Device_1_State_machine():  # MSN设备1的循环状态机
    global machine_model, time_out, key_eff, key_on, State_change, s1, s2, s3, color_use, Label2, photo_path1, photo_path2, write_path1, write_path2, LCD_Change_use, LCD_Change_now, write_path3, write_path4, Img_data_use
